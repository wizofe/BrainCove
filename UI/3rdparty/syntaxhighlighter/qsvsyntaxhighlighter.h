...
{
public:
	QsvSyntaxHighlighter( QTextDocument *parent, QsvColorDefFactory *colors=0, QsvLangDef *lang=0 );
	QsvSyntaxHighlighter( QTextEdit *parent, QsvColorDefFactory *colors=0, QsvLangDef *lang=0 );
